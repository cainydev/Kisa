...
<div class="flex flex-col border rounded">
    <div class="flex items-center justify-between px-3 py-2 border-b shadow-inner wrap">
        ...
        <span>
            <button class="btn btn-info" title="Download" wire:click="download">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
                    <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z" />
                    <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z" />
                </svg>
            </button>
            <button class="btn btn-danger" title="Löschen" wire:click="delete">
    ...
    <div class="px-3 py-2">
        ...
        @if($entity->getFirstMedia($collection)->hasGeneratedConversion('small'))
        ...
        @else
        <button class="relative w-full btn btn-success">
            <span wire:loading.remove>{{ $title }} hochladen</span>
            <x-icons.icon-loading wire:loading.flex class="w-8 h-8 mx-auto fill-white" />
            <input class="absolute inset-0 opacity-0 cursor-pointer" type="file" wire:model="document" />
        </button>
        @endif
    </div>
