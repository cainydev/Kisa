<div class="grid gap-8 mt-16 mb-96">
        ...
        <div class="p-4 bg-white rounded shadow-sm">
            ...
            <div x-init="$focus.focus($el)"
                ...
                <button x-ref="trigger"
                        x-on:focusin="open = true; $focus.focus($refs.search)"
                ...
                <span x-show="open"
                    ...
                    <div class="overflow-y-scroll">
                        ...
                        <button x-on:keydown.enter="$el.click()"
                                x-on:click="open = false"
                                wire:click="setProduct({{ $options->id }})"
                                class="@if($loop->even) bg-gray-200 shadow-inner @endif focus-visible:bg-gray-600 focus-visible:text-white w-full px-3 py-2 text-left hover:bg-gray-600 hover:text-white">
                            {{ $options->name }}
                        </button>
                        @endforeach
                    </div>
                ...
                <span x-show="open"
                    ...
                    <div class="overflow-y-scroll">
                        ...
                        <button x-on:click="open = false"
                                ...
                                class="w-full px-3 py-2 text-left focus-visible:bg-gray-600 focus-visible:text-white hover:bg-gray-600 hover:text-white">
                            {{ $option->size }}g
                        </button>
                        @endforeach
                    </div>
    ...
    <div>
        ...
        <div class="flex flex-col p-4 bg-white rounded shadow-sm">
            ...
            <div
                 class="@if($loop->even) bg-gray-100 @endif w-full justify-between flex space-x-3 items-center px-2 py-1">
                ...
                <span class="flex items-center justify-between shrink-0">
                    ...
                    <button class="shrink-0 w-9 h-9 group"
                            title="Löschen"
                            wire:click="delete({{ $pos->id }})">
